       ...
       //     groupBox5.Text = "коэффициент вливания капитала в государство " + k1.ToString();
        ...
        private void trackBar4_Scroll(object sender, EventArgs e)
        {
         ...
         //   groupBox2.Text = "Базовая сложность структуры государства= " + x1.ToString();
           ...
           //  label2.Text="Закон насыщения потребностей - с удовлетворение потребности в каком-либо благе его ценность падает или убывает";
            ...
            if (l1 > k1)
                label1.Text = "коэффициент вливания капитала в развитие гос-структуры не достиг предела";
            if (l1 == k1)
                label1.Text = "коэффициент вливания капитала в развитие гос-структуры достиг предела";
            if (l1 < k1)
        ...
        private void trackBar5_Scroll(object sender, EventArgs e)
        {
         ...
         //   groupBox4.Text = "Лимит вливаний в гос-структуру= " + l1.ToString();
            ...
            if (k1 < l1)
                label1.Text = "коэффициент вливания в гос-структуру не достигнут";
            if (k1 == l1)
        ...
        private void trackBar6_Scroll(object sender, EventArgs e)
        {
          ...
          //  groupBox5.Text = "коэффициент вливания капитала в государство " + k1.ToString();
            ...
            if (l2 > k2)
                label1.Text = "коэффициент вливания капитала в развитие экономики не достиг предела";
            if (l2 == k2)
        ...
        private void trackBar7_Scroll(object sender, EventArgs e)
        {
         ...
         //   groupBox6.Text = "Лимит вливаний в экономику= " + l2.ToString();
            ...
            //ПРАВИЛА
               ...
               if (k2 < l2)
                   label1.Text = "коэффициент вливания в экономику не достигнут";
               if (k2 == l2)
